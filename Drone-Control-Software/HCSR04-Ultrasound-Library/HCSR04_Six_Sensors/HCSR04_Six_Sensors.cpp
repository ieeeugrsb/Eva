...
**********************************************************************/
  ...
  _number_sensors = num_sensors;  //Load number of sensors used
  triger = new int[_number_sensors];
  echo = new int[_number_sensors];  /*Create triger and echo arrays with the length of the number of sensors
